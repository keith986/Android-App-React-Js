import { LoadBalancer, ChannelControlHelper, TypedLoadBalancingConfig } from 'google-gax/node_modules/@grpc/grpc-js/build/src/load-balancer';
...
import { Endpoint } from 'google-gax/node_modules/@grpc/grpc-js/build/src/subchannel-address';
...
export declare class LeafLoadBalancer {
    ...
    constructor(endpoint: Endpoint, channelControlHelper: ChannelControlHelper, credentials: ChannelCredentials, options: ChannelOptions);
