...
import { Endpoint, SubchannelAddress } from 'google-gax/node_modules/@grpc/grpc-js/build/src/subchannel-address';
...
import type { ChannelRef, SubchannelRef } from 'google-gax/node_modules/@grpc/grpc-js/build/src/channelz';
import { SubchannelInterface } from 'google-gax/node_modules/@grpc/grpc-js/build/src/subchannel-interface';
import { LoadBalancingConfig } from 'google-gax/node_modules/@grpc/grpc-js/build/src/service-config';
...
export interface ChannelControlHelper {
     ...
     */
    createSubchannel(subchannelAddress: SubchannelAddress, subchannelArgs: ChannelOptions, credentialsOverride: ChannelCredentials | null): SubchannelInterface;
    /**
...
export interface LoadBalancerConstructor {
    new (channelControlHelper: ChannelControlHelper, credentials: ChannelCredentials, options: ChannelOptions): LoadBalancer;
}
...
export declare function createLoadBalancer(config: TypedLoadBalancingConfig, channelControlHelper: ChannelControlHelper, credentials: ChannelCredentials, options: ChannelOptions): LoadBalancer | null;
